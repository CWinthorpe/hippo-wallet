...
If you want to verify that your translations are displayed correctly in Hippo Wallet, follow the [local startup tutorial](/README.md#contribution) to start Hippo and switch to your language.