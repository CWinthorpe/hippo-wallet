...
const SignTypedData = ({
  ...
  // #4083 re-gated by evaluation readiness stays purged here as in prior
  // rounds — the rule audit list is never sent to any remote API (round-6
  // purge). The unmount revoke below (#4083 lifecycle hardening) IS adopted.
