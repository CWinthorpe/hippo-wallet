...
const main = async () => {
  ...
  // Business stores (account, chains, exchange, contact book) initialize only
  // after the remote-data privacy policy is configured — see
  // src/ui/views/RemoteDataPolicy. Booting here would start business data
  // reads before the operator has consented.
